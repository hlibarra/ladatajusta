...
from app.api.routes.scraping_runs import router as scraping_runs_router
...
api_router.include_router(scraping_runs_router, prefix="/scraping-runs", tags=["scraping-runs"])
